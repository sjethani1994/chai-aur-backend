...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.log(err);
    throw new ApiError(500, "Server Error when getting user's playlists");
  }
});
...
const getPlaylistById = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(500, "Server Error when getting playlist details");
  }
});
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500, "Server Error when adding videos to playlist.");
  }
});
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500, "Server Error when removing videos to playlist.");
  }
});
...
const updatePlaylist = asyncHandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500, "Server Error when updating playlist.");
  }
});
